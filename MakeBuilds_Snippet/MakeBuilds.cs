...
using System.IO;
using System;
 //1. drop this in your Unity project in Assets\Editor.
 //2. Set the VERSION_STRING variable to something meaningful for your game.
 //3. use the menu option to make mac/linux/windows builds.
